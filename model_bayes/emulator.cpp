...
int main(int argc, char* argv[]){
	...
	*/
	x_init = 0;
	x_final = 10;;
	dx = (x_final - x_init)/(double) train;
	for(i=0;i<train;i++){
	  xvec_train_mat(i,0) = x_init + i*dx;
	...
	output_mat = gaussian_process_solver_basic(kernal_square_exp_function, xvec_train_mat, yvec_train_mat, xvec_test_mat, samples, hyperp_vec, epsilon);
