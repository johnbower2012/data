...
int main(int argc, char* argv[]){
  ...
  //For writing to file
  std::string param_filename, beta_filename, outfilename, trainfilename;
...
***********************************************************/
  ...
  arma::mat beta = arma::zeros<arma::mat>(observables,1+param);
  load_beta_file(beta_filename,beta);
